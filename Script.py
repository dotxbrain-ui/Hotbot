...
🎬 ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ᴅᴏᴛxʙʀᴀɪɴ ʜᴏᴛ ᴠɪᴅᴇᴏ ʙᴏᴛ!
🔥 ʙʀɪɴɢɪɴɢ ʏᴏᴜ ᴄᴏᴛᴛᴏɴ, ʜᴏᴛᴛɪᴇs & ᴇᴠᴇɴ ᴛʜᴇ ʜᴏᴛᴛᴇsᴛ ᴇɴᴅᴏʀᴘʜɪɴᴇ
🎞️ ɴᴏ ʟɪɴᴋs • ɴᴏ ᴀds • ᴊᴜst ᴘᴜʀᴇ Pøʀɴ ᴍᴀɢɪᴄ ✨
📥 ᴇɴᴛᴇʀ ᴛʜᴇ Pøʀɴ ɴᴀᴍᴇ ʏᴏᴜ ᴡɪll ʟᴏᴠᴇ
👉Wᴀɴᴛ ʙᴇsᴛ ᴠɪᴅᴇᴏs ɪᴜsᴛ sᴇᴀʀᴄʜ "ғɪʟᴇ"
...
𝗠𝗲𝘀𝘀𝗮𝗴𝗲 <b>: {}</b>"""
    ...
    CAPTION = """<b>📂 ғɪʟᴇɴᴀᴍᴇ : @dotxbrain {file_name}
